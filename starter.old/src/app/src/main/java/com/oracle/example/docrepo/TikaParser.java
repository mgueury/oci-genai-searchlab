/* 
  Test the function with OCI client
   oci fn function invoke --function-id ocid1.fnfunc.oc1.eu-frankfurt-1.xxxx \
    --body '{"bucketName": "opensearch-bucket", "namespace": "xxxx", "resourceName": "dance.pdf"}' --file /tmp/response  
*/
